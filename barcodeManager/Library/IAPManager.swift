...
extension Notification.Name {
    ...
    static let IAPManagerFailureNotification = Notification.Name("IAPManagerFailureNotification")
}
...
extension IAPManager: SKPaymentTransactionObserver {
    ...
    private func restore(transaction: SKPaymentTransaction) {
        guard let productIdentifier =
            transaction.original?.payment.productIdentifier else { return }
    ...
    private func fail(transaction: SKPaymentTransaction) {
        ...
        if let transactionError = transaction.error as NSError?,
            ...
            deliverFailureNotification(error: transactionError)
    ...
    private func deliverFailureNotification(error: NSError? = nil) {
        NotificationCenter.default.post(name: .IAPManagerFailureNotification, object: error)
    }
